  ...
  <section id="header">
        ...
        <div>
            <ul id="navbar" class="   ">
                ...
                <li class=" d-lg-block d-none"><a class="active" href="cart.php"><img style="size: 100px;margin-top:2px;width:20px;height:20px;" src="resourses/Shopping Bag.png" alt=""></></a></li>
                        ...
                        <div class="col-12">
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-2 mb-3 d-grid">
                                    <button class="btn btn-outline-primary" style="background-color: #9A002C;color:aliceblue;">Search</button>
                                </div>
                            </div>
                        </div>
